...
<title>  Facturaci&acute;n Anterior y Actual  </title>
</head>
<body >
...
<input type="hidden" id="desable_cifra" value="22">
	...
	<button type="button" class="btn btn-default dropdown-toggle menuLocal" data-toggle="dropdown" aria-expanded="false">
    							...
    							&emsp;Facturas mes anterior vs mes actual</span> <span class="glyphicon glyphicon-menu-down" id="menuDown"></span> 
  								</button>
...
<div class="col-md-12"><br><br></div>
	...
	<script src="${pageContext.request.contextPath}/js/reportes/facturaAntAct.js" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/generic/accounting.js" type="text/javascript"></script>
	<script> $('#contra2 span').addClass('desabilitado');  $('#empresa').hide(); </script>		
</body>
</html>