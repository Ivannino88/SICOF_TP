...
<title>Salida de Equipos vs Equipos Capitalizados SAP</title>
</head>
      ...
      <jsp:include page="/jsp/header/etiquetaCtrlInven.jsp"/>
   			<div class="col-md-8 etiquetaDivGeneral" >  
				...
				<div class="col-md-1"><!--  **************div vacio 4*************  -->	</div>
				    ...
				    </div>  <!-- fin elementos head  -->
</div>	<!-- fin principal head  -->
<br>
<br>
				<!-- ***********************  menu desplegable  *****************  -->
<div class="col-md-12">
...
<input type="hidden" id="desable_cifra" value="5">
	...
	<button type="button" class="btn btn-default dropdown-toggle menuLocal" data-toggle="dropdown" aria-expanded="false">
    							...
    							&emsp;Salida de Equipos vs Equipos Capitalizados SAP- SAP</span> <span class="glyphicon glyphicon-menu-down" id="menuDown"></span> 
  								</button>
	...
	<div class="col-md-5  text-right contentReporte">
		<div id="descargaArchivo elemento">
						  	<form action="exportDetalleSalidaEqvsEqCapitalizadosSAP" method="get">
				    ...
				    <div class="modal-dialog modal-lg" role="document" style="width:90%;">
				      ...
				      <div class="modal-content">
				        	<div class="modal-header" id="radioButtonContainerId">	        					
	        					...
	        					<div class="radio">
								  <label><input type="radio" name="1" value="1" id="op1">Salida de Eq vs Eq Capitalizados SAP</label>
								</div>
...
<div class="col-md-12">
<div class="contentReporte">
	<hr>
		<center> <span class="Total">TOTAL</span></center>
...
<script src="${pageContext.request.contextPath}/js/reportes/salidaEqvsEqCapitalizadosSAP.js" type="text/javascript"></script>
