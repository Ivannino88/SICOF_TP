...
<!-- ***********************  menu desplegable  *****************  -->
	...
	<input type="hidden" id="desable_cifra" value="1">
	<jsp:include page="/jsp/generic/loadModal.jsp" />		
						<button type="button" class="btn btn-default dropdown-toggle menuLocal" data-toggle="dropdown" aria-expanded="false">
    							...
    							&emsp;Instalaciones vs Salidas de Almacen SAP - BRM</span> <span class="glyphicon glyphicon-menu-down" id="menuDown"></span> 
  								</button>	
		...
		<div class="col-md-2 text-right contentReporte dropdown">
					<div id="descargaArchivo elemento">
					  	<form action="exportInstalacionesvsSalidasAlmacenSAPDetails">
			...
			<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" onselectstart="return false;">
					...
					<div class="modal-header">
					        ...
					        <div class="col-md-12 text-left">
	      						<button class="btn btn-info" id="opc1">Detalle de las cuentas existentes en SAP y no en BRM</button>
	      						<button class="btn btn-success" id="opc2">Detalle de las cuentas existentes en BRM y no en SAP</button>
	      					</div>
			...
			<div class="col-md-6 contenedorR">
				...
				<table class="table">
					...
					<tbody class="filasText">
						...
						<tr>
							<td class="tdx"><div class="divx1">&emsp;&emsp;&emsp;&emsp;&emsp;Encontrado SAP</div></td>
							<td class="tdx"><div class="divx1"><span class="Error_sap" id="Error_sap"></span></div></td>
							<td class="tdx"><div class="divx1"><span class="porcentajeErrorSAP" id="porcentajeErrorSAP"></span></div></td>
						</tr>
						<tr>
						...
						<tr>
              				...
              				<td><div class="ttotal"><b class=" Totalx Totalsap2"></div></td>
              				<td></td>
            			</tr>
					</tbody>
				</table>
			...
			<h2 class="espacio"></h2>
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td class="headTable">Total de Base SAP</td>
						</tr>
						<tr>
							<td class="lateralBlue">
							<span class="aln" id="No_Sap"></span>
							<div class="pull-right bcolorSAP"></div>
							</td>
						</tr>
...
<div class="row"><br><br><br></div>	
	...
	<script src="${pageContext.request.contextPath}/js/reportes/instVsSalidasAlmacenSAP2.js" type="text/javascript"></script>
