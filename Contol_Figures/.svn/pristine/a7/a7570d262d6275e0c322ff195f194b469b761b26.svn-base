...
<title>  Ajuste mes anterior vs mes actual</title>
</head>
<body >
...
<div class="col-md-12">
  	...
  	<!--  		<div class=" col-md-4" >	</div> -->
			...
			<div  class="col-md-3" ><!-- espacio bacio --></div>
			...
			<div  class="col-md-1"><br><!-- espacio bacio --></div>
...
<input type="hidden" id="desable_cifra" value="21">
	...
	<button type="button" class="btn btn-default dropdown-toggle menuLocal" data-toggle="dropdown" aria-expanded="false">
    							...
    							&emsp; Ajuste Mes Anterior vs Mes Actual</span> <span class="glyphicon glyphicon-menu-down" id="menuDown"></span> 
  								</button>
...
<br>
	...
	<jsp:include page="/jsp/generic/loadModal.jsp" />
	<jsp:include page="/jsp/generic/cargando.jsp" />
...
<div class="col-md-12"><br><br></div>
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="${pageContext.request.contextPath}/js/reportes/AjusteMantMact.js"
		type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/generic/accounting.js" type="text/javascript"></script>
	<script> $('#contra1 span').addClass('desabilitado');
			$('#empresa').hide();
	</script>			
</body>
</html>