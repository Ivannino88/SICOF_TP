...
function construyeReporte(jsonResponse) {
	...
	$.each(
		...
		function(index, arrayValores) {
			...
			html = html + '</td>';
			html = html + '<td>';
			html = html + arrayValores.fechaFN;
			html = html + '</td>';
			html = html + '<td>';
			html = html + accounting.formatMoney(arrayValores.monto_fact_ant);
			html = html + '</td>';
			html = html + '<td>';
			html = html +  arrayValores.fecha_nuevaActu;
			html = html + '</td>';
			html = html + '<td>';
			html = html +  accounting.formatMoney(arrayValores.monto_fact_act);
			html = html + '</td>';
