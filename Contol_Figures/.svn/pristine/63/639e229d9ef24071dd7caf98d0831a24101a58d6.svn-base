...
<title>Instalaciones vs. Salidas de Almac&eacute;n SAP - BRM</title>
<style type="text/css">
...
<body onload="javascript: cargaReporte(); getValor()" style="background: #fcfcfc">

	<jsp:include page="/jsp/generic/errorModal.jsp"/>

<div class="row container-fluid fondo">       <!-- inicio contenedorR head -->
      <jsp:include page="/jsp/header/etiquetaFFM.jsp"/>
<!-- divs encabezado -->
					...
					<div class="col-md-3" align="center">
				      <p  class="elemento"><span>Selecciona&nbsp;una&nbsp;fecha:</span></p>
							...
							<span class="input-group-addon">
								...
								<input readonly onchange="cargaReporte();" type="text" id="fecha" class="datepicker  form-control fechaJson"> 
							</div>
						</div>
				    </div>
...
<input type="hidden" id="desable_cifra" value="24">
		<jsp:include page="/jsp/generic/loadModal.jsp" />
			<button type="button" class="btn btn-default dropdown-toggle menuLocal" data-toggle="dropdown" aria-expanded="false">
    							...
    							&emsp;Small World vs FFM</span> <span class="glyphicon glyphicon-menu-down" id="menuDown"></span> 
  								</button>	
			...
			<div id="descargaArchivo elemento">
							  	<form action="exportDetalleFfmCuentasNoSwDetails">
		      ...
		      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" onselectstart="return false;">
				    <div class="modal-dialog modal-lg" role="document" style="width:90%;">
				      ...
				      <div class="modal-content">
					        ...
					        <div class="col-md-12">
					           <div class="col-md-4"><button class="btn btn-primary" onclick="consultaX1()">Detalle de FFM que no esta Small World</button></div>
					           <div class="col-md-4"><button class="btn btn-info" onclick="consultaX2()">Detalle de Small World que no esta en FFM</button></div>
					           <div class="col-md-4"><button class="btn btn-success" onclick="consultaX3()">Datos Inconsistentes</button></div>
					        </div>
...
<div class="container-fluid contentReporte">
			...
			<div class="col-md-6 contenedorR">
				...
				<table class="table">
					...
					<tbody class="filasText">
						...
						<tr>
							<td class="tdx"><div class="divx1">&emsp;&emsp;&emsp;&emsp;&emsp;Encontrado SW</div></td>
							<td class="tdx"><div class="divx1"><span class="Error_sw" id="Error_sw"></span></div></td>
							<td class="tdx"><div class="divx1"><span class="porcentajeErrorSW" id="porcentajeErrorSW"></span></div></td>
						</tr>
						<tr>
							<td style="border:0px;"><div class="divx2">&emsp;&emsp;&emsp;&emsp;&emsp;Encontrado en FFM</div></td>
							<td style="border:0px;"><div class="divx2"><span class="Error_Ffm" id="Error_Ffm"></span></div></td>
							<td style="border:0px;"><div class="divx2"><span class="porcentajeErrorFFM" id="porcentajeErrorFFM"></span></div></td>
						</tr>
						<tr>
              				<td><div class="ttotal"><b class="Totalx">Total</div></td>
              				<td><div class="ttotal"><b class=" Totalx Totalsmall"></div></td>
              				<td></td>
            			</tr>
					</tbody>
				</table>
			...
			<h2 class="espacio"></h2>
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td class="headTable">Total de Base SW</td>
						</tr>
						<tr>
							<td class="lateralBlue">							
							<span class="aln" id="No_Sw"></span>
								<div class="pull-right bcolorSW"></div>
							</td>
						</tr>
						...
						<tr>
							...
							<P class="totalBlue Totalsmall"></P>
	...
	<script src="${pageContext.request.contextPath}/js/reportes/smallWorld.js" type="text/javascript"></script>
	...
	<script >
	$('#ffm1 span').addClass('desabilitado');
	</script>
</body>
</html>