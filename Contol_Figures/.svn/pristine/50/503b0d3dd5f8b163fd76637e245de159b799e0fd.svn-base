...
public class CtasActBRMvsU2000LO_ExcelSN_DAO {
	
	private static final Logger logger = Logger.getLogger(CtasActBRMvsU2000LO_ExcelSN_DAO.class);
	...
	public ArrayList<LineasInternasVO> leerExcel(File file) throws IOException {
	   ...
	   //para leer desde el segundo renglon 
	 //   if(iterator.hasNext())
	 //   iterator.next();
